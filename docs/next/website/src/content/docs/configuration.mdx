...
Press **prefix then o** to start OpenCode immediately in the selected pane's
...
same managed launch as new-tab auto-start, including the ephemeral loopback HTTP
endpoint needed for child-session splits. No shell alias or profile setup is needed.
